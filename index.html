  ...
  <div class="main-content flex flex-col items-center p-6 md:p-12 text-center">
    ...
    <div id="home-view" class="w-full max-w-4xl mx-auto">
      ...
      <section class="bg-white/5 p-6 rounded-xl border border-cyan-500/20 mb-6">
        ...
        <p class="text-gray-200">Hello! I'm Mustufa, a passionate visual creator. I craft engaging graphics and dynamic video edits. I transform concepts into strong visual stories—professional, modern, and fast.</p>
      </section>
